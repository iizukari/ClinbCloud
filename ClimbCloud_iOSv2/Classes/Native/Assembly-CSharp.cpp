...
IL2CPP_EXTERN_C String_t* _stringLiteral5AE5024AE856044142F8C65B7F01E2902E650EDF;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void PlayerController_Update_m38903EF1C8F12B9388303741F8040EE26C33DC33 (PlayerController_t4CE339054014370D89B89922EDC0EA2766589C85 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		NullCheck(L_4);
		Animator_SetTrigger_m68D29B7FA54C2F230F5AD780D462612B18E74245(L_4, _stringLiteral5AE5024AE856044142F8C65B7F01E2902E650EDF, /*hidden argument*/NULL);
		Rigidbody2D_tBDC6900A76D3C47E291446FF008D02B817C81CDE * L_5 = __this->get_rigid2D_4();
		...
		float L_8 = __this->get_jumpForce_6();
		...
		NullCheck(L_5);
		Rigidbody2D_AddForce_mFE4658C0AE6643026A7CE7452857CA37DB687436(L_5, L_10, /*hidden argument*/NULL);
	}

IL_0055:
	{
		V_0 = 0;
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_11 = Input_get_acceleration_m1C80F95D29AC211181E9DD28AAFAA472AC82E2C4(/*hidden argument*/NULL);
		float L_12 = L_11.get_x_0();
		float L_13 = __this->get_threshold_9();
...
IL_006b:
	{
		...
		float L_16 = __this->get_threshold_9();
...
IL_0080:
	{
		Rigidbody2D_tBDC6900A76D3C47E291446FF008D02B817C81CDE * L_17 = __this->get_rigid2D_4();
		NullCheck(L_17);
		Vector2_tA85D2DD88578276CA8A8796756458277E72D073D  L_18 = Rigidbody2D_get_velocity_m5ABF36BDF90FD7308BE608667B9E8F3DA5A207F1(L_17, /*hidden argument*/NULL);
		float L_19 = L_18.get_x_0();
		IL2CPP_RUNTIME_CLASS_INIT(Mathf_tFBDE6467D269BFE410605C7D806FD9991D4A89CB_il2cpp_TypeInfo_var);
		float L_20 = fabsf(L_19);
		V_1 = L_20;
		float L_21 = V_1;
		float L_22 = __this->get_maxWalkSpeed_8();
	...
	{
		Rigidbody2D_tBDC6900A76D3C47E291446FF008D02B817C81CDE * L_23 = __this->get_rigid2D_4();
		...
		NullCheck(L_24);
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_25 = Transform_get_right_mC32CE648E98D3D4F62F897A2751EE567C7C0CFB0(L_24, /*hidden argument*/NULL);
		int32_t L_26 = V_0;
		IL2CPP_RUNTIME_CLASS_INIT(Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720_il2cpp_TypeInfo_var);
		Vector3_tDCF05E21F632FE2BA260C06E0D10CA81513E6720  L_27 = Vector3_op_Multiply_m1C5F07723615156ACF035D88A1280A9E8F35A04E(L_25, (((float)((float)L_26))), /*hidden argument*/NULL);
		float L_28 = __this->get_walkForce_7();
		...
		NullCheck(L_23);
		Rigidbody2D_AddForce_mFE4658C0AE6643026A7CE7452857CA37DB687436(L_23, L_30, /*hidden argument*/NULL);
	}
...
IL_00cc:
	...
	}
	{
		...
		Vector3__ctor_m08F61F548AA5836D8789843ACB4A81E4963D2EE1((&L_34), (((float)((float)L_33))), (1.0f), (1.0f), /*hidden argument*/NULL);
		NullCheck(L_32);
		Transform_set_localScale_m7ED1A6E5A87CD1D483515B99D6D3121FB92B0556(L_32, L_34, /*hidden argument*/NULL);
	}

IL_00eb:
	{
		Rigidbody2D_tBDC6900A76D3C47E291446FF008D02B817C81CDE * L_35 = __this->get_rigid2D_4();
		NullCheck(L_35);
	...
	{
		Animator_tF1A88E66B3B731DDA75A066DBAE9C55837660F5A * L_38 = __this->get_animator_5();
		float L_39 = V_1;
		NullCheck(L_38);
		Animator_set_speed_mEA558D196D84684744A642A56AFBF22F16448813(L_38, ((float)((float)L_39/(float)(2.0f))), /*hidden argument*/NULL);
		goto IL_0126;
	}

IL_0116:
	{
		Animator_tF1A88E66B3B731DDA75A066DBAE9C55837660F5A * L_40 = __this->get_animator_5();
		NullCheck(L_40);
		Animator_set_speed_mEA558D196D84684744A642A56AFBF22F16448813(L_40, (1.0f), /*hidden argument*/NULL);
	}
